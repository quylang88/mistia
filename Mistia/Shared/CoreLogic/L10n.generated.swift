...
nonisolated enum L10n {
    ...
    nonisolated enum settings {
        ...
        nonisolated enum shortcut {
            ...
            static var title: String { L10n.tr("settings.shortcut.title", vi: "Lối tắt Mistia", en: "Mistia shortcut", ja: "ミスティアショートカット") }
            static func title(language: MistiaAppLanguage) -> String { L10n.tr("settings.shortcut.title", vi: "Lối tắt Mistia", en: "Mistia shortcut", ja: "ミスティアショートカット", language: language) }
        }
