...
nonisolated enum L10n {
    ...
    nonisolated enum management {
        ...
        nonisolated enum management {
            ...
            static func categoryArchiveBlockedWithCounts(_ arg1: String, _ arg2: String) -> String {
                L10n.format("management.management.categoryArchiveBlockedWithCounts", vi: "Chưa thể lưu trữ danh mục này. Còn %@ ngân sách tháng hiện tại và %@ hóa đơn định kỳ đang hoạt động trong nhánh.", en: "Can't archive this category yet. This branch still has %@ current-month budgets and %@ active recurring bills.", ja: "このカテゴリはまだアーカイブできません。この枝には当月予算 %@ 件、有効な定期請求 %@ 件があります。", arg1, arg2)
            }
            static func categoryArchiveBlockedWithCounts(_ arg1: String, _ arg2: String, language: MistiaAppLanguage) -> String {
                L10n.format("management.management.categoryArchiveBlockedWithCounts", vi: "Chưa thể lưu trữ danh mục này. Còn %@ ngân sách tháng hiện tại và %@ hóa đơn định kỳ đang hoạt động trong nhánh.", en: "Can't archive this category yet. This branch still has %@ current-month budgets and %@ active recurring bills.", ja: "このカテゴリはまだアーカイブできません。この枝には当月予算 %@ 件、有効な定期請求 %@ 件があります。", language: language, arg1, arg2)
            }
            static var categoryBudgetBranchCurrentMonthBlock: String { L10n.tr("management.management.categoryBudgetBranchCurrentMonthBlock", vi: "Nhánh danh mục này đang được dùng bởi ngân sách tháng hiện tại. Hãy xóa hẳn các ngân sách tháng này trước khi đổi tên hoặc cấu trúc.", en: "This category branch is used by a current-month budget. Permanently delete those budgets before changing the name or structure.", ja: "このカテゴリ枝は当月の予算で使用されています。名前や構造を変更する前に、その月の予算を完全に削除してください。") }
            static func categoryBudgetBranchCurrentMonthBlock(language: MistiaAppLanguage) -> String { L10n.tr("management.management.categoryBudgetBranchCurrentMonthBlock", vi: "Nhánh danh mục này đang được dùng bởi ngân sách tháng hiện tại. Hãy xóa hẳn các ngân sách tháng này trước khi đổi tên hoặc cấu trúc.", en: "This category branch is used by a current-month budget. Permanently delete those budgets before changing the name or structure.", ja: "このカテゴリ枝は当月の予算で使用されています。名前や構造を変更する前に、その月の予算を完全に削除してください。", language: language) }
        ...
        nonisolated enum managementauth {
            ...
            static var local: String { L10n.tr("management.managementauth.local", vi: "Local", en: "Local", ja: "ローカル") }
            static func local(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.local", vi: "Local", en: "Local", ja: "ローカル", language: language) }
    ...
    nonisolated enum planning {
        ...
        nonisolated enum planning {
            ...
            static var currentBudgetCanBeDeleted: String { L10n.tr("planning.planning.currentBudgetCanBeDeleted", vi: "Ngân sách tháng hiện tại cần xóa hẳn thay vì lưu trữ.", en: "Current-month budgets must be deleted instead of archived.", ja: "当月の予算はアーカイブではなく削除してください。") }
            static func currentBudgetCanBeDeleted(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.currentBudgetCanBeDeleted", vi: "Ngân sách tháng hiện tại cần xóa hẳn thay vì lưu trữ.", en: "Current-month budgets must be deleted instead of archived.", ja: "当月の予算はアーカイブではなく削除してください。", language: language) }
            ...
            static var delete: String { L10n.tr("planning.planning.delete", vi: "Xóa", en: "Delete", ja: "削除") }
            static func delete(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.delete", vi: "Xóa", en: "Delete", ja: "削除", language: language) }
            static var deleteBudget: String { L10n.tr("planning.planning.deleteBudget", vi: "Xóa hẳn ngân sách", en: "Delete budget", ja: "予算を削除") }
            static func deleteBudget(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.deleteBudget", vi: "Xóa hẳn ngân sách", en: "Delete budget", ja: "予算を削除", language: language) }
            static var deleteCurrentBudgetMessage: String { L10n.tr("planning.planning.deleteCurrentBudgetMessage", vi: "Ngân sách tháng hiện tại sẽ bị xóa hẳn. Nếu đây là ngân sách cuối cùng trong nhánh, dữ liệu gia đình của nhánh sẽ tắt.", en: "The current-month budget will be deleted. If it is the last budget in this branch, family data for the branch will turn off.", ja: "当月の予算を削除します。この枝の最後の予算の場合、枝の家族データはオフになります。") }
            ...
            static var deleteThisBudget: String { L10n.tr("planning.planning.deleteThisBudget", vi: "Xóa hẳn ngân sách này?", en: "Delete this budget?", ja: "この予算を削除しますか？") }
            static func deleteThisBudget(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.deleteThisBudget", vi: "Xóa hẳn ngân sách này?", en: "Delete this budget?", ja: "この予算を削除しますか？", language: language) }
            ...
            static var enableFamilyBudgetDataMessage: String { L10n.tr("planning.planning.enableFamilyBudgetDataMessage", vi: "Từ bây giờ, mọi ngân sách trong nhánh này sẽ tính cả chi tiêu gia đình cùng danh mục. Muốn tắt, bạn phải xóa hẳn ngân sách tháng hiện tại của nhánh.", en: "From now on, every budget in this branch will include family spending in matching categories. To turn it off, you must permanently delete the current-month budgets in this branch.", ja: "今後、この枝のすべての予算は一致するカテゴリの家族支出も集計します。オフにするには、この枝の当月予算を完全に削除する必要があります。") }
            static func enableFamilyBudgetDataMessage(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.enableFamilyBudgetDataMessage", vi: "Từ bây giờ, mọi ngân sách trong nhánh này sẽ tính cả chi tiêu gia đình cùng danh mục. Muốn tắt, bạn phải xóa hẳn ngân sách tháng hiện tại của nhánh.", en: "From now on, every budget in this branch will include family spending in matching categories. To turn it off, you must permanently delete the current-month budgets in this branch.", ja: "今後、この枝のすべての予算は一致するカテゴリの家族支出も集計します。オフにするには、この枝の当月予算を完全に削除する必要があります。", language: language) }
            ...
            static var pastBudgetCanOnlyBeArchived: String { L10n.tr("planning.planning.pastBudgetCanOnlyBeArchived", vi: "Ngân sách tháng cũ chỉ có thể lưu trữ.", en: "Past-month budgets can only be archived.", ja: "過去月の予算はアーカイブのみ可能です。") }
            static func pastBudgetCanOnlyBeArchived(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.pastBudgetCanOnlyBeArchived", vi: "Ngân sách tháng cũ chỉ có thể lưu trữ.", en: "Past-month budgets can only be archived.", ja: "過去月の予算はアーカイブのみ可能です。", language: language) }
            static var pastBudgetReadOnlyReference: String { L10n.tr("planning.planning.pastBudgetReadOnlyReference", vi: "Ngân sách tháng cũ là bản tham chiếu chỉ đọc. Bạn chỉ có thể lưu trữ ngân sách này.", en: "Past-month budgets are read-only reference records. You can only archive this budget.", ja: "過去月の予算は参照用の読み取り専用レコードです。この予算はアーカイブのみ可能です。") }
            static func pastBudgetReadOnlyReference(language: MistiaAppLanguage) -> String { L10n.tr("planning.planning.pastBudgetReadOnlyReference", vi: "Ngân sách tháng cũ là bản tham chiếu chỉ đọc. Bạn chỉ có thể lưu trữ ngân sách này.", en: "Past-month budgets are read-only reference records. You can only archive this budget.", ja: "過去月の予算は参照用の読み取り専用レコードです。この予算はアーカイブのみ可能です。", language: language) }
    ...
    nonisolated enum settings {
        ...
        nonisolated enum footer {
            static var version: String { L10n.tr("settings.footer.version", vi: "version 16.09 powered by Quý Lăng", en: "version 16.09 powered by Quy Lang", ja: "バージョン 16.09 / Quy Lang 提供") }
            static func version(language: MistiaAppLanguage) -> String { L10n.tr("settings.footer.version", vi: "version 16.09 powered by Quý Lăng", en: "version 16.09 powered by Quy Lang", ja: "バージョン 16.09 / Quy Lang 提供", language: language) }
        }
