...
nonisolated enum L10n {
    ...
    nonisolated enum management {
        ...
        nonisolated enum managementauth {
            ...
            static var merge: String { L10n.tr("management.managementauth.merge", vi: "Gộp dữ liệu", en: "Merge Data", ja: "データを統合") }
            static func merge(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.merge", vi: "Gộp dữ liệu", en: "Merge Data", ja: "データを統合", language: language) }
            ...
            static var replaceLocal: String { L10n.tr("management.managementauth.replaceLocal", vi: "Thay thế dữ liệu", en: "Replace Data", ja: "データを置換") }
            static func replaceLocal(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.replaceLocal", vi: "Thay thế dữ liệu", en: "Replace Data", ja: "データを置換", language: language) }
