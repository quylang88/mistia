...
nonisolated enum L10n {
    ...
    nonisolated enum common {
        ...
        nonisolated enum chart {
            static var date: String { L10n.tr("common.chart.date", vi: "Ngày", en: "Date", ja: "日付") }
            static func date(language: MistiaAppLanguage) -> String { L10n.tr("common.chart.date", vi: "Ngày", en: "Date", ja: "日付", language: language) }
            static var spending: String { L10n.tr("common.chart.spending", vi: "Chi tiêu", en: "Spending", ja: "支出") }
            static func spending(language: MistiaAppLanguage) -> String { L10n.tr("common.chart.spending", vi: "Chi tiêu", en: "Spending", ja: "支出", language: language) }
            static var value: String { L10n.tr("common.chart.value", vi: "Giá trị", en: "Value", ja: "値") }
            static func value(language: MistiaAppLanguage) -> String { L10n.tr("common.chart.value", vi: "Giá trị", en: "Value", ja: "値", language: language) }
        }
    ...
    nonisolated enum investment {
        ...
        nonisolated enum asset {
            ...
            static var deleteAction: String { L10n.tr("investment.asset.deleteAction", vi: "Xóa tài sản", en: "Delete Asset", ja: "商品を削除") }
            static func deleteAction(language: MistiaAppLanguage) -> String { L10n.tr("investment.asset.deleteAction", vi: "Xóa tài sản", en: "Delete Asset", ja: "商品を削除", language: language) }
            static var deleteConfirmation: String { L10n.tr("investment.asset.deleteConfirmation", vi: "Tài sản này sẽ bị xóa khỏi danh sách. Lịch sử giao dịch đã tất toán vẫn được giữ lại. Bạn có muốn tiếp tục?", en: "This asset will be removed from your asset list. Its completed transaction history will be kept. Do you want to continue?", ja: "この商品を商品リストから削除します。完了した取引履歴は保持されます。続けますか？") }
            static func deleteConfirmation(language: MistiaAppLanguage) -> String { L10n.tr("investment.asset.deleteConfirmation", vi: "Tài sản này sẽ bị xóa khỏi danh sách. Lịch sử giao dịch đã tất toán vẫn được giữ lại. Bạn có muốn tiếp tục?", en: "This asset will be removed from your asset list. Its completed transaction history will be kept. Do you want to continue?", ja: "この商品を商品リストから削除します。完了した取引履歴は保持されます。続けますか？", language: language) }
        ...
        nonisolated enum cashTransfer {
            static var amount: String { L10n.tr("investment.cashTransfer.amount", vi: "Số tiền", en: "Amount", ja: "金額") }
            static func amount(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.amount", vi: "Số tiền", en: "Amount", ja: "金額", language: language) }
            static var deleteAction: String { L10n.tr("investment.cashTransfer.deleteAction", vi: "Xóa giao dịch chuyển tiền", en: "Delete transfer", ja: "振替を削除") }
            static func deleteAction(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.deleteAction", vi: "Xóa giao dịch chuyển tiền", en: "Delete transfer", ja: "振替を削除", language: language) }
            static var deleteConfirmation: String { L10n.tr("investment.cashTransfer.deleteConfirmation", vi: "Xóa giao dịch chuyển tiền của Ví Đầu tư này?", en: "Delete this Investment Wallet transfer?", ja: "この投資ウォレット振替を削除しますか？") }
            static func deleteConfirmation(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.deleteConfirmation", vi: "Xóa giao dịch chuyển tiền của Ví Đầu tư này?", en: "Delete this Investment Wallet transfer?", ja: "この投資ウォレット振替を削除しますか？", language: language) }
            static var deleteDescription: String { L10n.tr("investment.cashTransfer.deleteDescription", vi: "Số dư ví và tiền đầu tư khả dụng sẽ được hoàn lại nếu không có giao dịch sau phụ thuộc vào khoản này.", en: "Wallet balances and available investment cash will be restored if no later transaction depends on this transfer.", ja: "後続の取引がこの振替に依存していない場合、ウォレット残高と利用可能な投資資金が復元されます。") }
            static func deleteDescription(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.deleteDescription", vi: "Số dư ví và tiền đầu tư khả dụng sẽ được hoàn lại nếu không có giao dịch sau phụ thuộc vào khoản này.", en: "Wallet balances and available investment cash will be restored if no later transaction depends on this transfer.", ja: "後続の取引がこの振替に依存していない場合、ウォレット残高と利用可能な投資資金が復元されます。", language: language) }
            static var depositTitle: String { L10n.tr("investment.cashTransfer.depositTitle", vi: "Bù tiền vào Ví Đầu tư", en: "Refill Investment Wallet", ja: "投資ウォレットに補充") }
            static func depositTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.depositTitle", vi: "Bù tiền vào Ví Đầu tư", en: "Refill Investment Wallet", ja: "投資ウォレットに補充", language: language) }

            nonisolated enum error {
                static var conflict: String { L10n.tr("investment.cashTransfer.error.conflict", vi: "Tiền đầu tư đã thay đổi trên thiết bị khác. Mistia sẽ tải lại dữ liệu mới nhất, bạn vui lòng thử lại.", en: "Investment cash changed on another device. Mistia will refresh the latest data; please try again.", ja: "別のデバイスで投資資金が変更されました。最新データを再取得してから、もう一度お試しください。") }
                static func conflict(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.error.conflict", vi: "Tiền đầu tư đã thay đổi trên thiết bị khác. Mistia sẽ tải lại dữ liệu mới nhất, bạn vui lòng thử lại.", en: "Investment cash changed on another device. Mistia will refresh the latest data; please try again.", ja: "別のデバイスで投資資金が変更されました。最新データを再取得してから、もう一度お試しください。", language: language) }
                static var directionLocked: String { L10n.tr("investment.cashTransfer.error.directionLocked", vi: "Không thể đổi chiều giao dịch. Hãy xóa và tạo giao dịch mới.", en: "The transfer direction cannot be changed. Delete it and create a new transfer instead.", ja: "振替方向は変更できません。削除して新しい振替を作成してください。") }
                static func directionLocked(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.error.directionLocked", vi: "Không thể đổi chiều giao dịch. Hãy xóa và tạo giao dịch mới.", en: "The transfer direction cannot be changed. Delete it and create a new transfer instead.", ja: "振替方向は変更できません。削除して新しい振替を作成してください。", language: language) }
                static var exceedsLimit: String { L10n.tr("investment.cashTransfer.error.exceedsLimit", vi: "Số tiền vượt quá giới hạn hiện tại. Vui lòng cập nhật số tiền rồi thử lại.", en: "The amount is above the current transfer limit. Refresh the amount and try again.", ja: "現在の振替上限を超えています。金額を更新してもう一度お試しください。") }
                static func exceedsLimit(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.error.exceedsLimit", vi: "Số tiền vượt quá giới hạn hiện tại. Vui lòng cập nhật số tiền rồi thử lại.", en: "The amount is above the current transfer limit. Refresh the amount and try again.", ja: "現在の振替上限を超えています。金額を更新してもう一度お試しください。", language: language) }
                static var hasDependents: String { L10n.tr("investment.cashTransfer.error.hasDependents", vi: "Một giao dịch phát sinh sau đang sử dụng khoản tiền này. Vui lòng chỉnh hoặc xóa giao dịch đó trước.", en: "A later transaction already uses this amount. Adjust or delete that transaction first.", ja: "後の取引でこの金額がすでに使用されています。先にその取引を修正または削除してください。") }
                static func hasDependents(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.error.hasDependents", vi: "Một giao dịch phát sinh sau đang sử dụng khoản tiền này. Vui lòng chỉnh hoặc xóa giao dịch đó trước.", en: "A later transaction already uses this amount. Adjust or delete that transaction first.", ja: "後の取引でこの金額がすでに使用されています。先にその取引を修正または削除してください。", language: language) }
            }
            static var fromWallet: String { L10n.tr("investment.cashTransfer.fromWallet", vi: "Từ ví", en: "From wallet", ja: "振替元ウォレット") }
            static func fromWallet(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.fromWallet", vi: "Từ ví", en: "From wallet", ja: "振替元ウォレット", language: language) }
            static var investmentWallet: String { L10n.tr("investment.cashTransfer.investmentWallet", vi: "Ví Đầu tư", en: "Investment Wallet", ja: "投資ウォレット") }
            static func investmentWallet(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.investmentWallet", vi: "Ví Đầu tư", en: "Investment Wallet", ja: "投資ウォレット", language: language) }
            static func maximum(_ value: String) -> String {
                L10n.format("investment.cashTransfer.maximum", vi: "Giới hạn hiện tại: %@", en: "Current limit: %@", ja: "現在の上限：%@", value)
            }
            static func maximum(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.cashTransfer.maximum", vi: "Giới hạn hiện tại: %@", en: "Current limit: %@", ja: "現在の上限：%@", language: language, value)
            }
            static var moveToLinkedFirst: String { L10n.tr("investment.cashTransfer.moveToLinkedFirst", vi: "Hãy chuyển tiền đầu tư từ các ví đang giữ về ví liên kết trước khi chuyển ra.", en: "Move investment cash from the other holding wallets into the linked wallet before transferring it out.", ja: "振替前に、他の保管ウォレットの投資資金をリンク済みウォレットへ移動してください。") }
            static func moveToLinkedFirst(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.moveToLinkedFirst", vi: "Hãy chuyển tiền đầu tư từ các ví đang giữ về ví liên kết trước khi chuyển ra.", en: "Move investment cash from the other holding wallets into the linked wallet before transferring it out.", ja: "振替前に、他の保管ウォレットの投資資金をリンク済みウォレットへ移動してください。", language: language) }
            static var note: String { L10n.tr("investment.cashTransfer.note", vi: "Ghi chú (không bắt buộc)", en: "Note (optional)", ja: "メモ（任意）") }
            static func note(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.note", vi: "Ghi chú (không bắt buộc)", en: "Note (optional)", ja: "メモ（任意）", language: language) }
            static var refillFull: String { L10n.tr("investment.cashTransfer.refillFull", vi: "Bù đủ", en: "Refill full amount", ja: "不足分を全額補充") }
            static func refillFull(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.refillFull", vi: "Bù đủ", en: "Refill full amount", ja: "不足分を全額補充", language: language) }
            static var sameWalletDeposit: String { L10n.tr("investment.cashTransfer.sameWalletDeposit", vi: "Số dư thực tế của ví không thay đổi. Khoản này sẽ được chuyển từ tiền thường sang tiền đầu tư khả dụng.", en: "The actual wallet balance will not change. This amount will be reclassified from ordinary cash to available investment cash.", ja: "実際のウォレット残高は変わりません。この金額は通常資金から利用可能な投資資金へ振り替えられます。") }
            static func sameWalletDeposit(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.sameWalletDeposit", vi: "Số dư thực tế của ví không thay đổi. Khoản này sẽ được chuyển từ tiền thường sang tiền đầu tư khả dụng.", en: "The actual wallet balance will not change. This amount will be reclassified from ordinary cash to available investment cash.", ja: "実際のウォレット残高は変わりません。この金額は通常資金から利用可能な投資資金へ振り替えられます。", language: language) }
            static var sameWalletWithdrawal: String { L10n.tr("investment.cashTransfer.sameWalletWithdrawal", vi: "Số dư thực tế của ví không thay đổi. Khoản này sẽ trở thành tiền thường trong ví liên kết.", en: "The actual wallet balance will not change. This amount will become ordinary cash in the linked wallet.", ja: "実際のウォレット残高は変わりません。この金額はリンク済みウォレットの通常資金になります。") }
            static func sameWalletWithdrawal(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.sameWalletWithdrawal", vi: "Số dư thực tế của ví không thay đổi. Khoản này sẽ trở thành tiền thường trong ví liên kết.", en: "The actual wallet balance will not change. This amount will become ordinary cash in the linked wallet.", ja: "実際のウォレット残高は変わりません。この金額はリンク済みウォレットの通常資金になります。", language: language) }
            static var time: String { L10n.tr("investment.cashTransfer.time", vi: "Thời gian", en: "Time", ja: "日時") }
            static func time(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.time", vi: "Thời gian", en: "Time", ja: "日時", language: language) }
            static var toWallet: String { L10n.tr("investment.cashTransfer.toWallet", vi: "Đến ví", en: "To wallet", ja: "振替先ウォレット") }
            static func toWallet(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.toWallet", vi: "Đến ví", en: "To wallet", ja: "振替先ウォレット", language: language) }
            static var transferAll: String { L10n.tr("investment.cashTransfer.transferAll", vi: "Chuyển hết", en: "Transfer all", ja: "全額振替") }
            static func transferAll(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.transferAll", vi: "Chuyển hết", en: "Transfer all", ja: "全額振替", language: language) }
            static var withdrawalTitle: String { L10n.tr("investment.cashTransfer.withdrawalTitle", vi: "Chuyển ra khỏi Ví Đầu tư", en: "Transfer out of Investment Wallet", ja: "投資ウォレットから振替") }
            static func withdrawalTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.cashTransfer.withdrawalTitle", vi: "Chuyển ra khỏi Ví Đầu tư", en: "Transfer out of Investment Wallet", ja: "投資ウォレットから振替", language: language) }
        }
        ...
        nonisolated enum error {
            static var arithmeticOverflow: String { L10n.tr("investment.error.arithmeticOverflow", vi: "Số tiền hoặc số lượng quá lớn để tính toán. Vui lòng kiểm tra lại thông tin giao dịch.", en: "The amount or quantity is too large to calculate. Please check the transaction details.", ja: "金額または数量が大きすぎて計算できません。取引内容を確認してください。") }
            static func arithmeticOverflow(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.arithmeticOverflow", vi: "Số tiền hoặc số lượng quá lớn để tính toán. Vui lòng kiểm tra lại thông tin giao dịch.", en: "The amount or quantity is too large to calculate. Please check the transaction details.", ja: "金額または数量が大きすぎて計算できません。取引内容を確認してください。", language: language) }
            ...
            static var closePositionsBeforeDelete: String { L10n.tr("investment.error.closePositionsBeforeDelete", vi: "Vui lòng bán hoặc tất toán hết hàng còn lại trước khi xóa tài sản này.", en: "Please sell or settle all remaining inventory before deleting this asset.", ja: "この商品を削除する前に、残っている在庫をすべて販売または精算してください。") }
            static func closePositionsBeforeDelete(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.closePositionsBeforeDelete", vi: "Vui lòng bán hoặc tất toán hết hàng còn lại trước khi xóa tài sản này.", en: "Please sell or settle all remaining inventory before deleting this asset.", ja: "この商品を削除する前に、残っている在庫をすべて販売または精算してください。", language: language) }
            ...
            static var insufficientPosition: String { L10n.tr("investment.error.insufficientPosition", vi: "Thay đổi này sẽ khiến một giao dịch bán không còn đủ số lượng đã mua. Vui lòng chỉnh hoặc xóa giao dịch bán liên quan trước.", en: "This change would leave a sale without enough purchased inventory. Adjust or delete the related sale first.", ja: "この変更を行うと、後の売却に必要な仕入れ在庫が不足します。関連する売却を先に修正または削除してください。") }
            static func insufficientPosition(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.insufficientPosition", vi: "Thay đổi này sẽ khiến một giao dịch bán không còn đủ số lượng đã mua. Vui lòng chỉnh hoặc xóa giao dịch bán liên quan trước.", en: "This change would leave a sale without enough purchased inventory. Adjust or delete the related sale first.", ja: "この変更を行うと、後の売却に必要な仕入れ在庫が不足します。関連する売却を先に修正または削除してください。", language: language) }
            static var invalidAmount: String { L10n.tr("investment.error.invalidAmount", vi: "Số tiền giao dịch không hợp lệ. Vui lòng kiểm tra lại tổng tiền và tỷ giá.", en: "The transaction amount is invalid. Please check the total amount and exchange rate.", ja: "取引金額が無効です。合計金額と為替レートを確認してください。") }
            static func invalidAmount(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.invalidAmount", vi: "Số tiền giao dịch không hợp lệ. Vui lòng kiểm tra lại tổng tiền và tỷ giá.", en: "The transaction amount is invalid. Please check the total amount and exchange rate.", ja: "取引金額が無効です。合計金額と為替レートを確認してください。", language: language) }
            ...
            static var invalidQuantity: String { L10n.tr("investment.error.invalidQuantity", vi: "Số lượng phải lớn hơn 0.", en: "Quantity must be greater than zero.", ja: "数量は0より大きい値にしてください。") }
            static func invalidQuantity(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.invalidQuantity", vi: "Số lượng phải lớn hơn 0.", en: "Quantity must be greater than zero.", ja: "数量は0より大きい値にしてください。", language: language) }
            ...
            static func invalidWallet(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.invalidWallet", vi: "Ví này không thể dùng cho thao tác đầu tư đó.", en: "This wallet cannot be used for this investment operation.", ja: "このウォレットはその投資操作には使用できません。", language: language) }
            static var missingAsset: String { L10n.tr("investment.error.missingAsset", vi: "Tài sản này không còn tồn tại.", en: "This asset no longer exists.", ja: "この資産は存在しません。") }
            static func missingAsset(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.missingAsset", vi: "Tài sản này không còn tồn tại.", en: "This asset no longer exists.", ja: "この資産は存在しません。", language: language) }
            static var missingExchangeRate: String { L10n.tr("investment.error.missingExchangeRate", vi: "Cần tỷ giá hối đoái để thực hiện giao dịch này.", en: "An exchange rate snapshot is required for this transaction.", ja: "この取引には為替レートのスナップショットが必要です。") }
            static func missingExchangeRate(language: MistiaAppLanguage) -> String { L10n.tr("investment.error.missingExchangeRate", vi: "Cần tỷ giá hối đoái để thực hiện giao dịch này.", en: "An exchange rate snapshot is required for this transaction.", ja: "この取引には為替レートのスナップショットが必要です。", language: language) }
            static var missingWallet: String { L10n.tr("investment.error.missingWallet", vi: "Vui lòng chọn một ví khả dụng.", en: "Please select an available wallet.", ja: "利用可能なウォレットを選択してください。") }
        ...
        nonisolated enum family {
            static var createAccess: String { L10n.tr("investment.family.createAccess", vi: "Tạo giao dịch & thêm tài sản", en: "Record trades & add assets", ja: "取引の記録と資産登録") }
            static func createAccess(language: MistiaAppLanguage) -> String { L10n.tr("investment.family.createAccess", vi: "Tạo giao dịch & thêm tài sản", en: "Record trades & add assets", ja: "取引の記録と資産登録", language: language) }
        ...
        nonisolated enum hub {
            ...
            static func addChannel(language: MistiaAppLanguage) -> String { L10n.tr("investment.hub.addChannel", vi: "Thêm kênh", en: "Add Channel", ja: "チャンネルを追加", language: language) }
            static var allChannels: String { L10n.tr("investment.hub.allChannels", vi: "Tất cả kênh", en: "All Channels", ja: "すべてのチャンネル") }
            ...
            static func emptyMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.hub.emptyMessage", vi: "Phân loại các danh mục đầu tư, nhóm tài sản hoặc hoạt động giao dịch thành từng kênh riêng biệt.", en: "Organize your investment categories, asset groups, or trading activities into dedicated channels.", ja: "投資カテゴリー、資産グループ、取引活動をチャンネルごとに分けて管理できます。", language: language) }
            static var emptyTitle: String { L10n.tr("investment.hub.emptyTitle", vi: "Bắt đầu kênh đầu tư đầu tiên", en: "Start Your First Investment Channel", ja: "最初の投資チャンネルを作成しましょう") }
            static func emptyTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.hub.emptyTitle", vi: "Bắt đầu kênh đầu tư đầu tiên", en: "Start Your First Investment Channel", ja: "最初の投資チャンネルを作成しましょう", language: language) }
            static var investedCapital: String { L10n.tr("investment.hub.investedCapital", vi: "Vốn đang đầu tư", en: "Invested Capital", ja: "投資元本") }
            static func investedCapital(language: MistiaAppLanguage) -> String { L10n.tr("investment.hub.investedCapital", vi: "Vốn đang đầu tư", en: "Invested Capital", ja: "投資元本", language: language) }
            ...
            static var noActivityForPeriod: String { L10n.tr("investment.hub.noActivityForPeriod", vi: "Chưa có giao dịch trong thời gian này.", en: "No transactions during this period.", ja: "この期間の取引履歴はありません。") }
            ...
            static var realizedProfitLoss: String { L10n.tr("investment.hub.realizedProfitLoss", vi: "Lợi nhuận đã ghi nhận", en: "Realized profit/loss", ja: "実現損益") }
            static func realizedProfitLoss(language: MistiaAppLanguage) -> String { L10n.tr("investment.hub.realizedProfitLoss", vi: "Lợi nhuận đã ghi nhận", en: "Realized profit/loss", ja: "実現損益", language: language) }
        ...
        nonisolated enum overview {
            ...
            static var privateMessage: String { L10n.tr("investment.overview.privateMessage", vi: "Danh mục đầu tư cá nhân của thành viên được bảo mật mặc định. Vui lòng gửi yêu cầu để xem thông tin.", en: "Personal investment portfolios are private by default. Request view access to examine details.", ja: "メンバーの個人投資ポートフォリオはデフォルトで非公開です。閲覧するにはアクセス権限をリクエストしてください。") }
            static func privateMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.overview.privateMessage", vi: "Danh mục đầu tư cá nhân của thành viên được bảo mật mặc định. Vui lòng gửi yêu cầu để xem thông tin.", en: "Personal investment portfolios are private by default. Request view access to examine details.", ja: "メンバーの個人投資ポートフォリオはデフォルトで非公開です。閲覧するにはアクセス権限をリクエストしてください。", language: language) }
        ...
        nonisolated enum permission {
            static var accessRequired: String { L10n.tr("investment.permission.accessRequired", vi: "Yêu cầu quyền truy cập danh mục đầu tư", en: "Investment Portfolio Access Required", ja: "投資ポートフォリオへのアクセス権が必要です") }
            static func accessRequired(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.accessRequired", vi: "Yêu cầu quyền truy cập danh mục đầu tư", en: "Investment Portfolio Access Required", ja: "投資ポートフォリオへのアクセス権が必要です", language: language) }
            static var managementMessage: String { L10n.tr("investment.permission.managementMessage", vi: "Bạn chưa có quyền quản lý danh mục đầu tư này. Hãy yêu cầu quyền quản lý từ chủ dữ liệu.", en: "You do not have permission to manage this investment portfolio. Request management access from the data owner.", ja: "この投資ポートフォリオを管理する権限がありません。データ所有者に管理権限をリクエストしてください。") }
            static func managementMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.managementMessage", vi: "Bạn chưa có quyền quản lý danh mục đầu tư này. Hãy yêu cầu quyền quản lý từ chủ dữ liệu.", en: "You do not have permission to manage this investment portfolio. Request management access from the data owner.", ja: "この投資ポートフォリオを管理する権限がありません。データ所有者に管理権限をリクエストしてください。", language: language) }
            static var managementRequiredTitle: String { L10n.tr("investment.permission.managementRequiredTitle", vi: "Chưa có quyền quản lý", en: "No Management Access", ja: "管理権限がありません") }
            static func managementRequiredTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.managementRequiredTitle", vi: "Chưa có quyền quản lý", en: "No Management Access", ja: "管理権限がありません", language: language) }
            ...
            static var requestCreate: String { L10n.tr("investment.permission.requestCreate", vi: "Yêu cầu quyền giao dịch", en: "Request Trade Access", ja: "取引権限をリクエスト") }
            static func requestCreate(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestCreate", vi: "Yêu cầu quyền giao dịch", en: "Request Trade Access", ja: "取引権限をリクエスト", language: language) }
            static var requestCreateSent: String { L10n.tr("investment.permission.requestCreateSent", vi: "Đã gửi yêu cầu quyền giao dịch", en: "Trade Access Request Sent", ja: "取引権限をリクエスト済み") }
            static func requestCreateSent(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestCreateSent", vi: "Đã gửi yêu cầu quyền giao dịch", en: "Trade Access Request Sent", ja: "取引権限をリクエスト済み", language: language) }
            ...
            static var requestEditSent: String { L10n.tr("investment.permission.requestEditSent", vi: "Đã gửi yêu cầu quyền quản lý", en: "Management Access Request Sent", ja: "管理権限をリクエスト済み") }
            static func requestEditSent(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestEditSent", vi: "Đã gửi yêu cầu quyền quản lý", en: "Management Access Request Sent", ja: "管理権限をリクエスト済み", language: language) }
            static var requestPendingMessage: String { L10n.tr("investment.permission.requestPendingMessage", vi: "Yêu cầu quyền đang chờ chủ danh mục đầu tư phê duyệt.", en: "The permission request is waiting for the investment portfolio owner's approval.", ja: "権限リクエストは投資ポートフォリオ所有者の承認待ちです。") }
            static func requestPendingMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestPendingMessage", vi: "Yêu cầu quyền đang chờ chủ danh mục đầu tư phê duyệt.", en: "The permission request is waiting for the investment portfolio owner's approval.", ja: "権限リクエストは投資ポートフォリオ所有者の承認待ちです。", language: language) }
            static var requestSentMessage: String { L10n.tr("investment.permission.requestSentMessage", vi: "Yêu cầu quyền đã được gửi tới chủ danh mục đầu tư.", en: "The permission request was sent to the investment portfolio owner.", ja: "権限リクエストを投資ポートフォリオの所有者に送信しました。") }
            static func requestSentMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestSentMessage", vi: "Yêu cầu quyền đã được gửi tới chủ danh mục đầu tư.", en: "The permission request was sent to the investment portfolio owner.", ja: "権限リクエストを投資ポートフォリオの所有者に送信しました。", language: language) }
            static var requestSentTitle: String { L10n.tr("investment.permission.requestSentTitle", vi: "Đã gửi yêu cầu", en: "Request Sent", ja: "リクエスト送信済み") }
            static func requestSentTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestSentTitle", vi: "Đã gửi yêu cầu", en: "Request Sent", ja: "リクエスト送信済み", language: language) }
            ...
            static var requestViewSent: String { L10n.tr("investment.permission.requestViewSent", vi: "Đã gửi yêu cầu quyền xem", en: "View Access Request Sent", ja: "閲覧権限をリクエスト済み") }
            static func requestViewSent(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.requestViewSent", vi: "Đã gửi yêu cầu quyền xem", en: "View Access Request Sent", ja: "閲覧権限をリクエスト済み", language: language) }
            static var sendFailedMessage: String { L10n.tr("investment.permission.sendFailedMessage", vi: "Không thể gửi yêu cầu quyền lúc này.", en: "Couldn't send the permission request right now.", ja: "現在、権限リクエストを送信できません。") }
            static func sendFailedMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.sendFailedMessage", vi: "Không thể gửi yêu cầu quyền lúc này.", en: "Couldn't send the permission request right now.", ja: "現在、権限リクエストを送信できません。", language: language) }
            static var sendFailedTitle: String { L10n.tr("investment.permission.sendFailedTitle", vi: "Chưa thể gửi yêu cầu", en: "Couldn't Send Request", ja: "リクエストを送信できませんでした") }
            static func sendFailedTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.sendFailedTitle", vi: "Chưa thể gửi yêu cầu", en: "Couldn't Send Request", ja: "リクエストを送信できませんでした", language: language) }
            static var tradeMessage: String { L10n.tr("investment.permission.tradeMessage", vi: "Bạn chưa có quyền mua hoặc bán trong danh mục đầu tư này. Hãy yêu cầu quyền giao dịch từ chủ dữ liệu.", en: "You do not have permission to buy or sell in this investment portfolio. Request trade access from the data owner.", ja: "この投資ポートフォリオで売買する権限がありません。データ所有者に取引権限をリクエストしてください。") }
            static func tradeMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.tradeMessage", vi: "Bạn chưa có quyền mua hoặc bán trong danh mục đầu tư này. Hãy yêu cầu quyền giao dịch từ chủ dữ liệu.", en: "You do not have permission to buy or sell in this investment portfolio. Request trade access from the data owner.", ja: "この投資ポートフォリオで売買する権限がありません。データ所有者に取引権限をリクエストしてください。", language: language) }
            static var tradeRequiredTitle: String { L10n.tr("investment.permission.tradeRequiredTitle", vi: "Chưa có quyền giao dịch", en: "No Trade Access", ja: "取引権限がありません") }
            static func tradeRequiredTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.tradeRequiredTitle", vi: "Chưa có quyền giao dịch", en: "No Trade Access", ja: "取引権限がありません", language: language) }
            static var viewMessage: String { L10n.tr("investment.permission.viewMessage", vi: "Danh mục đầu tư này thuộc quyền riêng tư của thành viên. Cần có sự cho phép để truy cập thông tin.", en: "This portfolio belongs to the member. Only authorized family members can access investment details.", ja: "このポートフォリオはメンバーの個人データです。承認されたファミリーメンバーのみが投資情報にアクセスできます。") }
            static func viewMessage(language: MistiaAppLanguage) -> String { L10n.tr("investment.permission.viewMessage", vi: "Danh mục đầu tư này thuộc quyền riêng tư của thành viên. Cần có sự cho phép để truy cập thông tin.", en: "This portfolio belongs to the member. Only authorized family members can access investment details.", ja: "このポートフォリオはメンバーの個人データです。承認されたファミリーメンバーのみが投資情報にアクセスできます。", language: language) }
        }
        ...
        nonisolated enum trade {
            static var asset: String { L10n.tr("investment.trade.asset", vi: "Tài sản", en: "Asset", ja: "資産") }
            static func asset(language: MistiaAppLanguage) -> String { L10n.tr("investment.trade.asset", vi: "Tài sản", en: "Asset", ja: "資産", language: language) }
            static func availableQuantity(_ value: String) -> String {
                L10n.format("investment.trade.availableQuantity", vi: "Có thể bán: %@", en: "Available to sell: %@", ja: "売却可能数量：%@", value)
            }
            static func availableQuantity(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.trade.availableQuantity", vi: "Có thể bán: %@", en: "Available to sell: %@", ja: "売却可能数量：%@", language: language, value)
            }
            ...
            static func clearSearch(language: MistiaAppLanguage) -> String { L10n.tr("investment.trade.clearSearch", vi: "Xóa tìm kiếm", en: "Clear Search", ja: "検索をクリア", language: language) }
            ...
            static var deleteDescription: String { L10n.tr("investment.trade.deleteDescription", vi: "Giao dịch đã xóa sẽ không còn ảnh hưởng đến tính toán vốn và lợi nhuận.", en: "Deleted transactions will be excluded from cost basis and profit calculations.", ja: "削除された取引は投資元本および損益の計算から除外されます。") }
            static func deleteDescription(language: MistiaAppLanguage) -> String { L10n.tr("investment.trade.deleteDescription", vi: "Giao dịch đã xóa sẽ không còn ảnh hưởng đến tính toán vốn và lợi nhuận.", en: "Deleted transactions will be excluded from cost basis and profit calculations.", ja: "削除された取引は投資元本および損益の計算から除外されます。", language: language) }
            static var fundingWallet: String { L10n.tr("investment.trade.fundingWallet", vi: "Ví thanh toán Mua", en: "Funding Wallet", ja: "支払元ウォレット") }
            ...
            static var isPromotionalFree: String { L10n.tr("investment.trade.isPromotionalFree", vi: "Hàng khuyến mãi", en: "Promotional item", ja: "販促品") }
            static func isPromotionalFree(language: MistiaAppLanguage) -> String { L10n.tr("investment.trade.isPromotionalFree", vi: "Hàng khuyến mãi", en: "Promotional item", ja: "販促品", language: language) }
            ...
            static var promotionalFreeBadge: String { L10n.tr("investment.trade.promotionalFreeBadge", vi: "Khuyến mãi", en: "Promotional", ja: "販促品") }
            static func promotionalFreeBadge(language: MistiaAppLanguage) -> String { L10n.tr("investment.trade.promotionalFreeBadge", vi: "Khuyến mãi", en: "Promotional", ja: "販促品", language: language) }
            static var promotionalFreeDescription: String { L10n.tr("investment.trade.promotionalFreeDescription", vi: "Thêm số lượng này vào kho và không trừ tiền từ ví.", en: "Add this quantity to inventory without deducting money from a wallet.", ja: "この数量を在庫に追加し、ウォレットからは差し引きません。") }
        ...
        nonisolated enum wallet {
            ...
            static func availableCashForTransfer(_ value: String) -> String {
                L10n.format("investment.wallet.availableCashForTransfer", vi: "Ví này có %@ tiền đầu tư khả dụng. Nếu chuyển nhiều hơn, toàn bộ khoản này sẽ vào Ví Đầu tư; phần vượt vẫn là tiền thường trong ví liên kết.", en: "This wallet has %@ of available investment cash. If you move more, all of this amount is assigned to Investment Wallet; the excess remains ordinary money in the linked wallet.", ja: "このウォレットには利用可能な投資資金が%@あります。これを超えて移動した場合、この金額の全額が投資ウォレットに割り当てられ、超過分はリンク済みウォレットの通常資金として残ります。", value)
            }
            static func availableCashForTransfer(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.wallet.availableCashForTransfer", vi: "Ví này có %@ tiền đầu tư khả dụng. Nếu chuyển nhiều hơn, toàn bộ khoản này sẽ vào Ví Đầu tư; phần vượt vẫn là tiền thường trong ví liên kết.", en: "This wallet has %@ of available investment cash. If you move more, all of this amount is assigned to Investment Wallet; the excess remains ordinary money in the linked wallet.", ja: "このウォレットには利用可能な投資資金が%@あります。これを超えて移動した場合、この金額の全額が投資ウォレットに割り当てられ、超過分はリンク済みウォレットの通常資金として残ります。", language: language, value)
            }
            static var availableCashInWallet: String { L10n.tr("investment.wallet.availableCashInWallet", vi: "Tiền đầu tư khả dụng trong ví này", en: "Available investment cash in this wallet", ja: "このウォレットで利用可能な投資資金") }
            static func availableCashInWallet(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.availableCashInWallet", vi: "Tiền đầu tư khả dụng trong ví này", en: "Available investment cash in this wallet", ja: "このウォレットで利用可能な投資資金", language: language) }
            static var availableInvestment: String { L10n.tr("investment.wallet.availableInvestment", vi: "Tiền đầu tư khả dụng", en: "Available investment cash", ja: "利用可能な投資資金") }
            static func availableInvestment(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.availableInvestment", vi: "Tiền đầu tư khả dụng", en: "Available investment cash", ja: "利用可能な投資資金", language: language) }
            ...
            static func historyAdjustment(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyAdjustment", vi: "Điều chỉnh tiền đầu tư", en: "Investment cash adjusted", ja: "投資資金を調整", language: language) }
            static var historyDeposit: String { L10n.tr("investment.wallet.historyDeposit", vi: "Đã bù tiền đầu tư", en: "Investment cash refilled", ja: "投資資金を補充") }
            static func historyDeposit(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyDeposit", vi: "Đã bù tiền đầu tư", en: "Investment cash refilled", ja: "投資資金を補充", language: language) }
            static var historyEmpty: String { L10n.tr("investment.wallet.historyEmpty", vi: "Chưa có biến động Ví Đầu tư.", en: "No Investment Wallet activity yet.", ja: "投資ウォレットの履歴はまだありません。") }
            static func historyEmpty(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyEmpty", vi: "Chưa có biến động Ví Đầu tư.", en: "No Investment Wallet activity yet.", ja: "投資ウォレットの履歴はまだありません。", language: language) }
            static var historyFilterAll: String { L10n.tr("investment.wallet.historyFilterAll", vi: "Tất cả", en: "All", ja: "すべて") }
            static func historyFilterAll(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyFilterAll", vi: "Tất cả", en: "All", ja: "すべて", language: language) }
            static var historyFilterIncoming: String { L10n.tr("investment.wallet.historyFilterIncoming", vi: "Tiền vào", en: "In", ja: "入金") }
            static func historyFilterIncoming(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyFilterIncoming", vi: "Tiền vào", en: "In", ja: "入金", language: language) }
            static var historyFilterMovement: String { L10n.tr("investment.wallet.historyFilterMovement", vi: "Di chuyển", en: "Moved", ja: "移動") }
            static func historyFilterMovement(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyFilterMovement", vi: "Di chuyển", en: "Moved", ja: "移動", language: language) }
            static var historyFilterOutgoing: String { L10n.tr("investment.wallet.historyFilterOutgoing", vi: "Tiền ra", en: "Out", ja: "出金") }
            static func historyFilterOutgoing(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyFilterOutgoing", vi: "Tiền ra", en: "Out", ja: "出金", language: language) }
            static func historyLiquidation(_ value: String) -> String {
                L10n.format("investment.wallet.historyLiquidation", vi: "Thanh lý %@", en: "Liquidated %@", ja: "%@を清算", value)
            }
            ...
            static func historyRealizedProfit(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyRealizedProfit", vi: "Lợi nhuận từ bán hàng", en: "Profit from sale", ja: "販売利益", language: language) }
            static func historySaleAmount(_ value: String) -> String {
                L10n.format("investment.wallet.historySaleAmount", vi: "Tiền bán: %@", en: "Sale amount: %@", ja: "販売金額：%@", value)
            }
            static func historySaleAmount(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.wallet.historySaleAmount", vi: "Tiền bán: %@", en: "Sale amount: %@", ja: "販売金額：%@", language: language, value)
            }
            static var historySeeAll: String { L10n.tr("investment.wallet.historySeeAll", vi: "Xem tất cả", en: "See all", ja: "すべて表示") }
            static func historySeeAll(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historySeeAll", vi: "Xem tất cả", en: "See all", ja: "すべて表示", language: language) }
            static var historySpending: String { L10n.tr("investment.wallet.historySpending", vi: "Đã dùng tiền đầu tư để chi tiêu", en: "Investment cash used for spending", ja: "支出に投資資金を使用") }
            static func historySpending(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historySpending", vi: "Đã dùng tiền đầu tư để chi tiêu", en: "Investment cash used for spending", ja: "支出に投資資金を使用", language: language) }
            static var historyTitle: String { L10n.tr("investment.wallet.historyTitle", vi: "Lịch sử Ví Đầu tư", en: "Investment Wallet History", ja: "投資ウォレット履歴") }
            static func historyTitle(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyTitle", vi: "Lịch sử Ví Đầu tư", en: "Investment Wallet History", ja: "投資ウォレット履歴", language: language) }
            static func historyWalletFlow(_ arg1: String, _ arg2: String) -> String {
                L10n.format("investment.wallet.historyWalletFlow", vi: "%@ → %@", en: "%@ → %@", ja: "%@ → %@", arg1, arg2)
            }
            static func historyWalletFlow(_ arg1: String, _ arg2: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.wallet.historyWalletFlow", vi: "%@ → %@", en: "%@ → %@", ja: "%@ → %@", language: language, arg1, arg2)
            }
            static var historyWithdrawal: String { L10n.tr("investment.wallet.historyWithdrawal", vi: "Đã chuyển tiền đầu tư ra", en: "Investment cash transferred out", ja: "投資資金を振替") }
            static func historyWithdrawal(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.historyWithdrawal", vi: "Đã chuyển tiền đầu tư ra", en: "Investment cash transferred out", ja: "投資資金を振替", language: language) }
            static func investmentPortion(_ value: String) -> String {
                L10n.format("investment.wallet.investmentPortion", vi: "Trong đó %@ là tiền đầu tư khả dụng", en: "Of which %@ is available investment cash", ja: "うち%@は利用可能な投資資金", value)
            }
            static func investmentPortion(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("investment.wallet.investmentPortion", vi: "Trong đó %@ là tiền đầu tư khả dụng", en: "Of which %@ is available investment cash", ja: "うち%@は利用可能な投資資金", language: language, value)
            }
            ...
            static var noLocations: String { L10n.tr("investment.wallet.noLocations", vi: "Không còn tiền đầu tư khả dụng.", en: "No available investment cash remains.", ja: "利用可能な投資資金は残っていません。") }
            static func noLocations(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.noLocations", vi: "Không còn tiền đầu tư khả dụng.", en: "No available investment cash remains.", ja: "利用可能な投資資金は残っていません。", language: language) }
            ...
            static var shortfall: String { L10n.tr("investment.wallet.shortfall", vi: "Cần bù", en: "Amount to refill", ja: "補充が必要な金額") }
            static func shortfall(language: MistiaAppLanguage) -> String { L10n.tr("investment.wallet.shortfall", vi: "Cần bù", en: "Amount to refill", ja: "補充が必要な金額", language: language) }
            static var transferOutAction: String { L10n.tr("investment.wallet.transferOutAction", vi: "Chuyển ra", en: "Transfer out", ja: "振替") }
            ...
            static func useFundsMessage(_ arg1: String, _ arg2: String) -> String {
                L10n.format("investment.wallet.useFundsMessage", vi: "Giao dịch này sẽ dùng %@ tiền đầu tư. Sau khi lưu, ví này còn %@ tiền đầu tư khả dụng. Lợi nhuận đã ghi nhận không thay đổi.", en: "This transaction will use %@ of investment cash. After saving, this wallet will have %@ of available investment cash left. Your realized profit/loss will not change.", ja: "この取引では投資資金を%@使用します。保存後、このウォレットで利用可能な投資資金は%@残ります。実現損益は変わりません。", arg1, arg2)
            }
    ...
    nonisolated enum management {
        ...
        nonisolated enum managementauth {
            ...
            static func backupRecordCount(_ count: Int) -> String {
                L10n.format("management.managementauth.backupRecordCount", vi: "%lld bản ghi", en: "%lld records", ja: "%lld件", Int64(count))
            }
            static func backupRecordCount(_ count: Int, language: MistiaAppLanguage) -> String {
                L10n.format("management.managementauth.backupRecordCount", vi: "%lld bản ghi", en: "%lld records", ja: "%lld件", language: language, Int64(count))
            }
            ...
            static func backupVersion(_ arg1: String, _ arg2: String) -> String {
                L10n.format("management.managementauth.backupVersion", vi: "v%@ (%@)", en: "v%@ (%@)", ja: "v%@（%@）", arg1, arg2)
            }
            static func backupVersion(_ arg1: String, _ arg2: String, language: MistiaAppLanguage) -> String {
                L10n.format("management.managementauth.backupVersion", vi: "v%@ (%@)", en: "v%@ (%@)", ja: "v%@（%@）", language: language, arg1, arg2)
            }
            ...
            static var noLocalBackup: String { L10n.tr("management.managementauth.noLocalBackup", vi: "Chưa có bản sao lưu nào trên thiết bị.", en: "No backups are available on this device.", ja: "この端末にはバックアップがありません。") }
            static func noLocalBackup(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.noLocalBackup", vi: "Chưa có bản sao lưu nào trên thiết bị.", en: "No backups are available on this device.", ja: "この端末にはバックアップがありません。", language: language) }
            ...
            static var syncConflictChooseVersion: String { L10n.tr("management.managementauth.syncConflictChooseVersion", vi: "Chọn bản dữ liệu muốn lưu", en: "Choose Version to Keep", ja: "残すデータを選択") }
            static func syncConflictChooseVersion(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.syncConflictChooseVersion", vi: "Chọn bản dữ liệu muốn lưu", en: "Choose Version to Keep", ja: "残すデータを選択", language: language) }
            ...
            static var syncConflictCloudNewerBanner: String { L10n.tr("management.managementauth.syncConflictCloudNewerBanner", vi: "Bản trên Cloud có thời gian sửa đổi mới hơn", en: "Cloud version was updated more recently", ja: "クラウド版の方が新しく更新されています") }
            static func syncConflictCloudNewerBanner(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.syncConflictCloudNewerBanner", vi: "Bản trên Cloud có thời gian sửa đổi mới hơn", en: "Cloud version was updated more recently", ja: "クラウド版の方が新しく更新されています", language: language) }
            static var syncConflictDeviceNewerBanner: String { L10n.tr("management.managementauth.syncConflictDeviceNewerBanner", vi: "Bản trên máy này có thời gian sửa đổi mới hơn", en: "This device version was updated more recently", ja: "このデバイス版の方が新しく更新されています") }
            static func syncConflictDeviceNewerBanner(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.syncConflictDeviceNewerBanner", vi: "Bản trên máy này có thời gian sửa đổi mới hơn", en: "This device version was updated more recently", ja: "このデバイス版の方が新しく更新されています", language: language) }
            static var syncConflictDifferences: String { L10n.tr("management.managementauth.syncConflictDifferences", vi: "Các điểm khác biệt", en: "Differences", ja: "相違点") }
            static func syncConflictDifferences(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.syncConflictDifferences", vi: "Các điểm khác biệt", en: "Differences", ja: "相違点", language: language) }
            static func syncConflictDifferentPrefix(_ value: String) -> String {
                L10n.format("management.managementauth.syncConflictDifferentPrefix", vi: "Khác biệt: %@", en: "Different: %@", ja: "相違: %@", value)
            }
            static func syncConflictDifferentPrefix(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("management.managementauth.syncConflictDifferentPrefix", vi: "Khác biệt: %@", en: "Different: %@", ja: "相違: %@", language: language, value)
            }
            static func syncConflictFieldCount(_ count: Int) -> String {
                L10n.format("management.managementauth.syncConflictFieldCount", vi: "%lld trường", en: "%lld fields", ja: "%lld項目", Int64(count))
            }
            static func syncConflictFieldCount(_ count: Int, language: MistiaAppLanguage) -> String {
                L10n.format("management.managementauth.syncConflictFieldCount", vi: "%lld trường", en: "%lld fields", ja: "%lld項目", language: language, Int64(count))
            }
            ...
            static var syncConflictUpdateTimes: String { L10n.tr("management.managementauth.syncConflictUpdateTimes", vi: "Thời gian cập nhật", en: "Update Times", ja: "更新日時") }
            static func syncConflictUpdateTimes(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.syncConflictUpdateTimes", vi: "Thời gian cập nhật", en: "Update Times", ja: "更新日時", language: language) }
    ...
    nonisolated enum settings {
        ...
        nonisolated enum feedback {
            ...
            static func attachmentCount(_ count: Int) -> String {
                L10n.format("settings.feedback.attachmentCount", vi: "%lld/5", en: "%lld/5", ja: "%lld/5", Int64(count))
            }
            static func attachmentCount(_ count: Int, language: MistiaAppLanguage) -> String {
                L10n.format("settings.feedback.attachmentCount", vi: "%lld/5", en: "%lld/5", ja: "%lld/5", language: language, Int64(count))
            }
            ...
            static func characterCount(_ arg1: Int, _ arg2: Int) -> String {
                L10n.format("settings.feedback.characterCount", vi: "%lld/%lld", en: "%lld/%lld", ja: "%lld/%lld", Int64(arg1), Int64(arg2))
            }
            static func characterCount(_ arg1: Int, _ arg2: Int, language: MistiaAppLanguage) -> String {
                L10n.format("settings.feedback.characterCount", vi: "%lld/%lld", en: "%lld/%lld", ja: "%lld/%lld", language: language, Int64(arg1), Int64(arg2))
            }
            ...
            nonisolated enum prompt {
                static var later: String { L10n.tr("settings.feedback.prompt.later", vi: "Để sau", en: "Later", ja: "後で") }
                static func later(language: MistiaAppLanguage) -> String { L10n.tr("settings.feedback.prompt.later", vi: "Để sau", en: "Later", ja: "後で", language: language) }
                static var message: String { L10n.tr("settings.feedback.prompt.message", vi: "Ý kiến của bạn giúp chúng tôi hoàn thiện Mistia hơn mỗi ngày.", en: "Your feedback helps us improve Mistia every day.", ja: "ご意見はMistiaをより良くするために役立ちます。") }
                static func message(language: MistiaAppLanguage) -> String { L10n.tr("settings.feedback.prompt.message", vi: "Ý kiến của bạn giúp chúng tôi hoàn thiện Mistia hơn mỗi ngày.", en: "Your feedback helps us improve Mistia every day.", ja: "ご意見はMistiaをより良くするために役立ちます。", language: language) }
                static var optOut: String { L10n.tr("settings.feedback.prompt.optOut", vi: "Không hỏi lại", en: "Don't Ask Again", ja: "今後表示しない") }
                static func optOut(language: MistiaAppLanguage) -> String { L10n.tr("settings.feedback.prompt.optOut", vi: "Không hỏi lại", en: "Don't Ask Again", ja: "今後表示しない", language: language) }
                static func ratingAccessibility(_ count: Int) -> String {
                    L10n.format("settings.feedback.prompt.ratingAccessibility", vi: "Đánh giá %lld trên 5", en: "Rating %lld out of 5", ja: "5段階中%lld", Int64(count))
                }
                static func ratingAccessibility(_ count: Int, language: MistiaAppLanguage) -> String {
                    L10n.format("settings.feedback.prompt.ratingAccessibility", vi: "Đánh giá %lld trên 5", en: "Rating %lld out of 5", ja: "5段階中%lld", language: language, Int64(count))
                }
                static var title: String { L10n.tr("settings.feedback.prompt.title", vi: "Bạn cảm thấy Mistia thế nào?", en: "How do you feel about Mistia?", ja: "Mistiaはいかがですか？") }
                static func title(language: MistiaAppLanguage) -> String { L10n.tr("settings.feedback.prompt.title", vi: "Bạn cảm thấy Mistia thế nào?", en: "How do you feel about Mistia?", ja: "Mistiaはいかがですか？", language: language) }
            }
    ...
    nonisolated enum transactions {
        ...
        nonisolated enum aibill {
            ...
            static var addItem: String { L10n.tr("transactions.aibill.addItem", vi: "Thêm món còn thiếu", en: "Add missing item", ja: "不足している商品を追加") }
            static func addItem(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.addItem", vi: "Thêm món còn thiếu", en: "Add missing item", ja: "不足している商品を追加", language: language) }
            ...
            static var analyzeAgain: String { L10n.tr("transactions.aibill.analyzeAgain", vi: "Phân tích lại", en: "Analyze again", ja: "再解析") }
            static func analyzeAgain(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.analyzeAgain", vi: "Phân tích lại", en: "Analyze again", ja: "再解析", language: language) }
            ...
            static var discountAmount: String { L10n.tr("transactions.aibill.discountAmount", vi: "Giảm giá", en: "Discount", ja: "値引き") }
            static func discountAmount(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.discountAmount", vi: "Giảm giá", en: "Discount", ja: "値引き", language: language) }
            ...
            static var editItem: String { L10n.tr("transactions.aibill.editItem", vi: "Sửa món", en: "Edit item", ja: "商品を編集") }
            static func editItem(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.editItem", vi: "Sửa món", en: "Edit item", ja: "商品を編集", language: language) }
            static var editTotal: String { L10n.tr("transactions.aibill.editTotal", vi: "Sửa tổng hóa đơn", en: "Edit receipt total", ja: "レシート合計を編集") }
            static func editTotal(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.editTotal", vi: "Sửa tổng hóa đơn", en: "Edit receipt total", ja: "レシート合計を編集", language: language) }
            static var finalRowAmount: String { L10n.tr("transactions.aibill.finalRowAmount", vi: "Thành tiền", en: "Line total", ja: "行合計") }
            static func finalRowAmount(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.finalRowAmount", vi: "Thành tiền", en: "Line total", ja: "行合計", language: language) }
            ...
            static func itemCount(_ value: String) -> String {
                L10n.format("transactions.aibill.itemCount", vi: "%@ dòng hàng", en: "%@ item lines", ja: "商品行 %@件", value)
            }
            static func itemCount(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("transactions.aibill.itemCount", vi: "%@ dòng hàng", en: "%@ item lines", ja: "商品行 %@件", language: language, value)
            }
            static var itemDetails: String { L10n.tr("transactions.aibill.itemDetails", vi: "Thông tin món hàng", en: "Item details", ja: "商品情報") }
            static func itemDetails(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.itemDetails", vi: "Thông tin món hàng", en: "Item details", ja: "商品情報", language: language) }
            static func itemDiscount(_ value: String) -> String {
                L10n.format("transactions.aibill.itemDiscount", vi: "Giảm %@", en: "Discount %@", ja: "値引き %@", value)
            }
            static func itemDiscount(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("transactions.aibill.itemDiscount", vi: "Giảm %@", en: "Discount %@", ja: "値引き %@", language: language, value)
            }
            static func itemsTotal(_ value: String) -> String {
                L10n.format("transactions.aibill.itemsTotal", vi: "Tổng món: %@", en: "Items total: %@", ja: "商品合計：%@", value)
            }
            static func itemsTotal(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("transactions.aibill.itemsTotal", vi: "Tổng món: %@", en: "Items total: %@", ja: "商品合計：%@", language: language, value)
            }
            static var lineType: String { L10n.tr("transactions.aibill.lineType", vi: "Loại dòng", en: "Line type", ja: "行の種類") }
            static func lineType(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.lineType", vi: "Loại dòng", en: "Line type", ja: "行の種類", language: language) }
            ...
            static var needsReview: String { L10n.tr("transactions.aibill.needsReview", vi: "Cần kiểm tra", en: "Review needed", ja: "要確認") }
            static func needsReview(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.needsReview", vi: "Cần kiểm tra", en: "Review needed", ja: "要確認", language: language) }
            ...
            static var originalName: String { L10n.tr("transactions.aibill.originalName", vi: "Tên trên hóa đơn", en: "Printed name", ja: "レシートの商品名") }
            static func originalName(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.originalName", vi: "Tên trên hóa đơn", en: "Printed name", ja: "レシートの商品名", language: language) }
            static var originalRowAmount: String { L10n.tr("transactions.aibill.originalRowAmount", vi: "Tổng giá gốc", en: "Original line total", ja: "値引き前の行合計") }
            static func originalRowAmount(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.originalRowAmount", vi: "Tổng giá gốc", en: "Original line total", ja: "値引き前の行合計", language: language) }
            static var printedText: String { L10n.tr("transactions.aibill.printedText", vi: "Nội dung trên hóa đơn", en: "Printed receipt text", ja: "レシートの印字内容") }
            static func printedText(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.printedText", vi: "Nội dung trên hóa đơn", en: "Printed receipt text", ja: "レシートの印字内容", language: language) }
            static var purchaseLine: String { L10n.tr("transactions.aibill.purchaseLine", vi: "Món hàng", en: "Purchase", ja: "購入商品") }
            static func purchaseLine(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.purchaseLine", vi: "Món hàng", en: "Purchase", ja: "購入商品", language: language) }
            static var quantity: String { L10n.tr("transactions.aibill.quantity", vi: "Số lượng", en: "Quantity", ja: "数量") }
            static func quantity(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.quantity", vi: "Số lượng", en: "Quantity", ja: "数量", language: language) }
            static var receiptActions: String { L10n.tr("transactions.aibill.receiptActions", vi: "Tùy chọn hóa đơn", en: "Receipt options", ja: "レシートの操作") }
            static func receiptActions(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.receiptActions", vi: "Tùy chọn hóa đơn", en: "Receipt options", ja: "レシートの操作", language: language) }
            static var receiptImage: String { L10n.tr("transactions.aibill.receiptImage", vi: "Ảnh hóa đơn", en: "Receipt image", ja: "レシート画像") }
            static func receiptImage(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.receiptImage", vi: "Ảnh hóa đơn", en: "Receipt image", ja: "レシート画像", language: language) }
            static var receiptTotal: String { L10n.tr("transactions.aibill.receiptTotal", vi: "Tổng thanh toán", en: "Receipt total", ja: "支払合計") }
            static func receiptTotal(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.receiptTotal", vi: "Tổng thanh toán", en: "Receipt total", ja: "支払合計", language: language) }
            static var receiptTotalHelp: String { L10n.tr("transactions.aibill.receiptTotalHelp", vi: "Nhập tổng thanh toán được in trên hóa đơn, sau thuế và giảm giá.", en: "Enter the payable total printed on the receipt, after tax and discounts.", ja: "税金・値引きを含めた、レシートに印字された支払合計を入力してください。") }
            static func receiptTotalHelp(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.receiptTotalHelp", vi: "Nhập tổng thanh toán được in trên hóa đơn, sau thuế và giảm giá.", en: "Enter the payable total printed on the receipt, after tax and discounts.", ja: "税金・値引きを含めた、レシートに印字された支払合計を入力してください。", language: language) }
            ...
            static var removeItem: String { L10n.tr("transactions.aibill.removeItem", vi: "Xóa dòng hàng", en: "Remove item", ja: "商品行を削除") }
            static func removeItem(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.removeItem", vi: "Xóa dòng hàng", en: "Remove item", ja: "商品行を削除", language: language) }
            ...
            static var reviewBeforeCreate: String { L10n.tr("transactions.aibill.reviewBeforeCreate", vi: "Đối chiếu ảnh gốc và sửa các món cần kiểm tra trước khi tạo giao dịch.", en: "Check the receipt image and correct flagged items before creating a transaction.", ja: "取引を作成する前に、画像と照合し、要確認の商品を修正してください。") }
            static func reviewBeforeCreate(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.reviewBeforeCreate", vi: "Đối chiếu ảnh gốc và sửa các món cần kiểm tra trước khi tạo giao dịch.", en: "Check the receipt image and correct flagged items before creating a transaction.", ja: "取引を作成する前に、画像と照合し、要確認の商品を修正してください。", language: language) }
            static var rowAmountHelp: String { L10n.tr("transactions.aibill.rowAmountHelp", vi: "Nhập tổng tiền cho toàn bộ số lượng của dòng hàng. Thành tiền bằng tổng giá gốc trừ giảm giá.", en: "Enter the total for the entire quantity on this line. The line total is the original amount minus the discount.", ja: "その行の数量すべての金額を入力してください。行合計は値引き前の金額から値引きを引いた金額です。") }
            static func rowAmountHelp(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.rowAmountHelp", vi: "Nhập tổng tiền cho toàn bộ số lượng của dòng hàng. Thành tiền bằng tổng giá gốc trừ giảm giá.", en: "Enter the total for the entire quantity on this line. The line total is the original amount minus the discount.", ja: "その行の数量すべての金額を入力してください。行合計は値引き前の金額から値引きを引いた金額です。", language: language) }
            ...
            static func totalDifference(_ value: String) -> String {
                L10n.format("transactions.aibill.totalDifference", vi: "Chênh lệch so với hóa đơn: %@", en: "Difference from receipt: %@", ja: "レシートとの差額：%@", value)
            }
            static func totalDifference(_ value: String, language: MistiaAppLanguage) -> String {
                L10n.format("transactions.aibill.totalDifference", vi: "Chênh lệch so với hóa đơn: %@", en: "Difference from receipt: %@", ja: "レシートとの差額：%@", language: language, value)
            }
            static var totalMatched: String { L10n.tr("transactions.aibill.totalMatched", vi: "Tổng tiền đã khớp", en: "Totals match", ja: "合計金額が一致") }
            static func totalMatched(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.totalMatched", vi: "Tổng tiền đã khớp", en: "Totals match", ja: "合計金額が一致", language: language) }
            static var translatedName: String { L10n.tr("transactions.aibill.translatedName", vi: "Tên dịch", en: "Translated name", ja: "翻訳名") }
            static func translatedName(language: MistiaAppLanguage) -> String { L10n.tr("transactions.aibill.translatedName", vi: "Tên dịch", en: "Translated name", ja: "翻訳名", language: language) }
