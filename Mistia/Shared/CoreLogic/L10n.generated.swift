...
nonisolated enum L10n {
    ...
    nonisolated enum management {
        ...
        nonisolated enum managementauth {
            ...
            static var signOutAndDeleteLocal: String { L10n.tr("management.managementauth.signOutAndDeleteLocal", vi: "Đăng xuất & xóa dữ liệu trên thiết bị", en: "Sign out & delete device data", ja: "サインアウト（端末データを削除）") }
            static func signOutAndDeleteLocal(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.signOutAndDeleteLocal", vi: "Đăng xuất & xóa dữ liệu trên thiết bị", en: "Sign out & delete device data", ja: "サインアウト（端末データを削除）", language: language) }
            static var signOutAndKeepLocal: String { L10n.tr("management.managementauth.signOutAndKeepLocal", vi: "Đăng xuất & giữ dữ liệu trên thiết bị", en: "Sign out & keep device data", ja: "サインアウト（端末データを保持）") }
            static func signOutAndKeepLocal(language: MistiaAppLanguage) -> String { L10n.tr("management.managementauth.signOutAndKeepLocal", vi: "Đăng xuất & giữ dữ liệu trên thiết bị", en: "Sign out & keep device data", ja: "サインアウト（端末データを保持）", language: language) }
